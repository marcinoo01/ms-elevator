...
public class MongoDbConfig {
    ...
    public void runner() {
        ...
        elevatorRepository.saveAll(List.of(elevator2, elevator3, elevator4, elevator5, elevator6, elevator1,elevator11, elevator12, elevator13, elevator14, elevator15, elevator16, elevator7, elevator8, elevator9, elevator10)).subscribe();
    }
}
